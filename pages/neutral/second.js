export default function NeutralSecondEvolution() {
    return <>
        <h3>
            Neutral/Swim/Swim
        </h3>
        ...
        <h4>
            Common name: "(Advanced) NiGHTS Chao"
        </h4>
        ...
        <p>
            A brighter blue colour and is just like the Basic Sonic Chao in shape, except with straighter spikes.
        </p>
